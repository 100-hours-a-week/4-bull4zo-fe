...
export const VoteItem = (vote: Partial<ParticipatedVote>) => {
  ...
  return (
    <li
      ...
      className={`flex flex-col px-4 py-6 border-[0.125rem] rounded-2xl gap-4 shadow-box ${vote.voteStatus === 'REJECTED' ? 'bg-red-200 cursor-pointer' : vote.voteStatus === 'PENDING' ? 'bg-zinc-200 cursor-not-allowed' : 'cursor-pointer'}`}
    >
